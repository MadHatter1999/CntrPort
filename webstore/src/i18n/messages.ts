...
const en: Dict = {
  ...
  "checkout.texts": "Receipts & offers",
  ...
  "checkout.emailMarketing": "Yes - I'd like to receive occasional offers and promotions from {store} by email.",
  "checkout.smsFine":
    "Optional and not a condition of purchase. Msg & data rates may apply for texts - reply STOP anytime to unsubscribe (HELP for help); every email includes an unsubscribe link. We record your consent as required by Canadian law (CASL).",
  ...
  "footer.demo": "Online store powered by CntrPort.",
